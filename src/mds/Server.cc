...
#if defined ADSLTAG_MIGRATION_CORRE_REQUEST && defined ADSLTAG_REQUEST_MANUALCNT
...
#else
    dout(0) << ADSLTAG_MIGRATION_CORRE_REQUEST << ' ' << adsl_req_get_injected_string(mdr) << dendl;
#endif
#endif
